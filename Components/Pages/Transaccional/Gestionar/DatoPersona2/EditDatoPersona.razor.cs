...
{
    public partial class EditDatoPersona
    {
        [Inject]
        ...
        {
            datoPersona = await reincardbService.GetDatoPersonaByIdDatoPersona(Id_Dato_Persona);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await reincardbService.UpdateDatoPersona(Id_Dato_Persona, datoPersona);
