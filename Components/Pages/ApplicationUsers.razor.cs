...
namespace Reincarapp.Components.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<Reincarapp.Models.ApplicationUser> users;
        protected RadzenDataGrid<Reincarapp.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(Reincarapp.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(Reincarapp.Models.ApplicationUser user)
        {
            try
            {
